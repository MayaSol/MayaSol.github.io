#Спасибо за внимательность при проверке!


#Замечнания по исправлениям

1. style-mini.css отличается от style.css, потому что http://cssminifier.com/ такое с ним делает. 

2. Кнопка Популярные товары на главной в psd названа с ошибкой - Попуряные товары, поэтому текст на .psd получается короче, а он отцентрован из-за этого при наложении не совпадает.


# Личный проект «Техномарт»

* Студент: [Майя Соловьёва](https://htmlacademy.ru/profile/id60303).
...
[Откройте репозиторий](https://github.com/htmlacademy-htmlcss/60303-technomart) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
